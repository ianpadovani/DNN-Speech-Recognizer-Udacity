...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for _ in range(recur_layers-1):
        rnn_x = GRU(units, activation='relu',
...
def all_in_one_model(filters=200, kernel_size=11, conv_stride=2,
                     conv_border_mode="valid", units=200, input_dim=13,
                     recur_layers=2, output_dim=29):
    ...
    # CONVOLUTIONAL LAYER
    # Add convolutional layer
    conv_1 = Conv1D(filters, kernel_size, 
                     strides=conv_stride, 
                     padding=conv_border_mode,
                     activation='relu',
                     name='conv1')(input_data)
    
    bn_cnn = BatchNormalization(name='bn_conv_1')(conv_1)
...
def final_model(input_dim=13, units=200, recur_layers=2, output_dim=29):
    """ Build a deep network for speech 
    """
    # Main acoustic input
    input_data = Input(name='the_input', shape=(None, input_dim))
